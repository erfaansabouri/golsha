        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <a href="{{ route('admin.faq-categories.create') }}" class="btn btn-success float-sm-left">تعریف دسته بندی جدید</a>
                    </div>
                </div>
                <div class="row">
                    <div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($faq_categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.faqs.index', ['category_id' => $category->id]) }}" class="btn btn-sm btn-info">سوالات</a>
                                                <a href="{{ route('admin.faq-categories.edit', $category->id) }}" class="btn btn-sm btn-primary">ویرایش</a>
