                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form class="form">
                                <div class="card-body">
                                    <div class="row">
                                        @if($record->type == \App\Models\Setting::TYPES['text'])
                                        <div class="col-8">
                                            <div class="form-group">
                                                <label for="title" class="control-label">مقدار</label>
                                                <div class="">
                                                    <textarea wire:model="value" type="text" class="form-control" id="value" placeholder="متن را وارد کنید"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        @endif
                                    ...
                                    <div class="row">
                                        @if($record->type == \App\Models\Setting::TYPES['image'])
                                        <div class="col-4">
                                            <div class="form-group">
