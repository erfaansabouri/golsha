...
<head>
    ...
    <title>پنل مدیریت | {{ $pageInfo['title'] }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/admin/persian-datepicker.min.css') }}">
    <!-- iCheck -->
    ...
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{ asset('assets/admin/datepicker/datepicker3.css') }}">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="{{ asset('assets/admin/daterangepicker/daterangepicker-bs3.css') }}">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="{{ asset('assets/admin/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }}">
