...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['public/assets/admin/admin/daterangepicker/moment', 'jquery', 'exports'], function(momentjs, $, exports) {
      root.daterangepicker = factory(root, exports, momentjs, $);
    });

  } else if (typeof exports !== 'undefined') {
    var momentjs = require('public/assets/admin/admin/daterangepicker/moment');
    var jQuery;
    try {
