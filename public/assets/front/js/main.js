    ...
    function callback(){
        ...
        if($(window).width() > 991){
            ...
            $(".navRowSubLi").hover( function(){
                    ...
                    $(this).find('.navSubBox').stop(true, true).delay(300).addClass('opnd');
                },
                function(){
                    $(this).find('.navRowSubLnk').removeClass('opened');
                    $(this).find('.navSubBox').stop(true, true).delay(200).removeClass('opnd');
                });
        }
        if($(window).width() <= 991){
            if ($(".opnSubLink").length) {
            ...
            $(".navRowSubLi").each(function(){
                var thisItem2 = $(this);
                var navSubBox = thisItem2.find(".navSubBox");

                thisItem2.find('.opnSubSub').click(function(){
                    var navRowSubLnk = thisItem2.find('.navRowSubLnk');
                    if (!navSubBox.hasClass('opened')) {
                        navSubBox.addClass('opened').removeClass('opnd');
                        navRowSubLnk.addClass('opened');
                        navRowSubLnk.find('span').addClass('opened');
                        thisItem2.siblings().find('.navSubBox').removeClass('opened');
